        ...
        <!-- 본문 시작 -->
            ...
            <div class="location_wrap">
                <div class="location_cont">
                    <em><a href="#" class="local_home">HOME</a> &gt; 마이페이지 &gt; 상품후기</em>
                </div>
            </div>
            <!-- //location_wrap -->
    ...
    <div class="board_zone_cont">
        <div class="board_zone_list" align="center">
            <table class="board_list_table" style="width:80%" "="">   <!-- width 100%로 하니까 리스트가 밑으로 내려가서 80으로 수정 -->
                ...
                <tr data-sno="22840" data-auth="y" style="height:10px">
                    <td>
                        27253
                    </td>
                    <td class="board_tit">
                        
                        <a href="javascript:gd_btn_view('goodsreview',22840 ,'y')">
                            <strong>푸짐한 불고기~</strong>
                ...
                <tr data-sno="22839" data-auth="y" style="height:10px">
                    <td>
                        27252
                    </td>
                    <td class="board_tit">
                        
                        <a href="javascript:gd_btn_view('goodsreview',22839 ,'y')">
                            <strong>맛있는 샤브샤브~</strong>
                            <img src="https://cdn-pro-web-134-253-godomall.spdycdn.net/mychef1_godomall_com/data/skin/front/udweb_pc_20200903/board/skin/default/img/icon/icon_board_new.png" alt="신규 등록글">
                        </a>
                    </td>
                    <td>
                ...
                <tr data-sno="22831" data-auth="y" style="height:10px">
                    <td>
                        27244
                    </td>
                    <td class="board_tit">
                        
                        <a href="javascript:gd_btn_view('goodsreview',22831 ,'y')">
                            <strong>맛있어요</strong>
