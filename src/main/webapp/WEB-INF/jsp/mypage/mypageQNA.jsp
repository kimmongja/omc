...
<head>
<meta charset="UTF-8">
<meta property="og:url" content="https://www.mychef.kr/board/list.php?bdId=qa&amp;noheader=y&amp;memNo=136262">
        ...
        <!-- 본문 시작 -->
            ...
            <div class="location_wrap">
                <div class="location_cont">
                    <em><a href="#" class="local_home">HOME</a> &gt; 마이페이지 &gt; 상품문의</em>
                </div>
            </div>
            <!-- //location_wrap -->
  ...
  <div class="board_zone_sec">
	...
	<div class="board_zone_cont">
		...
		<div class="btn_right_box">
			<button type="button" class="btn_write" onclick="gd_btn_write('goodsqa')"><strong>상품 문의하기</strong></button>
		</div>
