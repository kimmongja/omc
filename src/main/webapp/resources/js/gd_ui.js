    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data =='false') {
                    ...
                    $.each(categoryVal, function (key, val) {
                        ...
                        if(val.children) {
                            ...
                            $.each(val.children, function (key1, val1) {
                                ...
                                if(val1.children) {
									addHtml += '<span style="position:absolute;"><i class="xi-angle-right" style="font-size:10px;padding:9px 0 7px 10px;vertical-align:bottom;color:#aaa;"></i>';
                                    ...
                                    $.each(val1.children, function (key2, val2) {
                                        ...
                                        if(val2.children) {
											addHtml += '<i class="xi-angle-right" style="font-size:10px;padding:9px 0 7px 10px;vertical-align:bottom;color:#aaa;"></i>';
                ...
                addHtml += '</ul>';
                addHtml += '</div><span class="btn_all_menu_close" onClick="gd_btn_all_menu_close();">전체메뉴닫기</span><span class="btn_all_menu_close2" onclick="gd_btn_all_menu_close();"></span></div>'
